...
- Name: playwright\api-validation.spec.ts >> API Validation Suite >> validate AI insights endpoint returns summary and signal data
- Location: playwright\api-validation.spec.ts:283:7
